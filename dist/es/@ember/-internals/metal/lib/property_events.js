...
import { PROPERTY_DID_CHANGE as ENABLE_PROPERTY_DID_CHANGE, PROPERTY_WILL_CHANGE as ENABLE_PROPERTY_WILL_CHANGE, } from '@ember/deprecated-features';
...
if (ENABLE_PROPERTY_WILL_CHANGE) {
    propertyWillChange = function propertyWillChange() {
        deprecate(`'propertyWillChange' is deprecated and has no effect. It is safe to remove this call.`, false, {
...
if (ENABLE_PROPERTY_DID_CHANGE) {
    propertyDidChange = function propertyDidChange(obj, keyName, _meta) {
        deprecate(`'propertyDidChange' is deprecated in favor of 'notifyPropertyChange'. It is safe to change this call to 'notifyPropertyChange'.`, false, {
...
export { propertyWillChange, propertyDidChange, notifyPropertyChange, overrideChains, beginPropertyChanges, endPropertyChanges, changeProperties, };
